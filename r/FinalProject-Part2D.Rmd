...
Define training control. We use 5-fold cross-validation that repeats 5 times. Our main performance metric would be `RMSE`.
```{r}
...
dotplot(model_compare)
```
From the results above, we could determine that Gradient Boosted Tree model is the best performing model with lowest RMSE.